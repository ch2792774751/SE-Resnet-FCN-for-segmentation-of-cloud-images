...
class CloudDataset(Dataset):
    ...
    def __init__(self, img_dir, labels_dir,val=False, transform=None):
        ...
        self.train_img_names=img_names[:12000]
        self.train_lab_names=lab_names[:12000]
        self.val_img_names=img_names[12000:14000]
        self.val_lab_names=lab_names[12000:14000]
...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        return {'image':image.type(torch.FloatTensor),'gt_map':gt_map.type(torch.FloatTensor)}
...
if __name__ == '__main__':
    ...
    for i in range(len(cloud_data)):
        ...
        if i == 3:
            break
    tarnsformed_dataset = CloudDataset(img_dir='data/images224',labels_dir='data/masks224/',transform=transforms.Compose([ToTensor()]))
    ...
    dataloader = DataLoader(tarnsformed_dataset, batch_size=4, shuffle=True, num_workers=4)
